...
export default function BoardFour() {
    ...
    const currentPlayer = gameContext.gameData.game.players[currentPlayerIndex]
    const player2 = gameContext.gameData.game.players[(1 + currentPlayerIndex) % 6]
    const player3 = gameContext.gameData.game.players[(2 + currentPlayerIndex) % 6]
    const player4 = gameContext.gameData.game.players[(3 + currentPlayerIndex) % 6]
    const player5 = gameContext.gameData.game.players[(4 + currentPlayerIndex) % 6]
    const player6 = gameContext.gameData.game.players[(5 + currentPlayerIndex) % 6]    
        ...
        <Container className="pt-3 px-4 py-4 bg-dark">
            <Row className="mb-2">             
                <Col xs="4" className="justify-content-center">                    
                    ...
                    {<img className="img-fluid inverted-deck" src= {require("../assets/MazoNaipes/" + checkRightDeck(player4) + ".png")}/>}                    
                    </Col>                    
                </Col>
                <Col xs="4">
                    <h5 className="text-white text-center">{player4.user.username}</h5>                    
                    <Row>                                                
                        {fillCards(showHand(player4)).map((item, index) => {
                ...
                <Col xs="4">                    
                    <Col xs={{span:4,offset:4}} className="mt-4">
                        {<img className="img-fluid horizontal-deck-right" src= {require("../assets/MazoNaipes/" + checkRightDeck(player3) + ".png")}/>}                        
                    </Col>
                </Col>      
            </Row>
            ...
            <Row className="justify-content-center">
                <Col xs="3" className="m-0 p-0">
                    <h5 className="text-white text-center verticaltext-left">{player5.user.username}</h5>                    
                    <Row className="horizontal-card-left">
                        {fillCards(showHand(player5)).reverse().map((item, index) => {
                            return <Col xs="4" className="px-1"><img className="img-fluid" key={index} src={require("../assets/MazoNaipes/" + item + ".png")} /></Col>
                        })}
                    </Row>
                </Col>
                ...
                <Col xs="5" className="border border-top-0 border-bottom-0">                    
                    <Row>
                        <Col xs="4">
                            {fillCards(player5.played).map((item, index) => {
                        ...
                        <Col xs="4">
                            {fillCards(player3.played).reverse().map((item, index) => {
                ...
                <Col xs="3" className="m-0 p-0">
                    ...
                    <h5 className="text-white text-center verticaltext-right">{player3.user.username}</h5>                    
            ...
            <Row className="justify-content-center ">
                <Col xs="3" className="justify-content-center">
                    <Col xs="5">
                        {<img className="img-fluid horizontal-deck-left" src= {require("../assets/MazoNaipes/" + checkRightDeck(player5) + ".png")}/>}                        
                    </Col>
                </Col>

                <Col xs="5" className="border border-bottom-0 border-top-0">     
                </Col>
            ...
            <Row className="justify-content-center">
                <Col xs="3" className="m-0 p-0">
                    <h5 className="text-white text-center verticaltext-left">{player6.user.username}</h5>
                    <Row className="horizontal-card-left">
                        {fillCards(showHand(player6)).reverse().map((item, index) => {
                            return <Col xs="4" className="px-1"><img className="img-fluid" key={index} src={require("../assets/MazoNaipes/" + item + ".png")} /></Col>
                        })}
                    </Row>
                </Col>
                ...
                <Col xs="5" className="border border-top-0 border-bottom-0">                    
                    <Row>
                        <Col xs="4">
                            {fillCards(player6.played).map((item, index) => {
                                return <Row className="px-3 py-0"><img className="img-fluid horizontal-played-card-right" key={index} src={require("../assets/MazoNaipes/" + item + ".png")} /></Row>
                            })}
                        </Col>
                        <Col xs="4">
                        ...
                        <Col xs="4">
                            {fillCards(player2.played).reverse().map((item, index) => {
                                return <Row className="px-3"><img className="img-fluid horizontal-played-card-left" key={index} src={require("../assets/MazoNaipes/" + item + ".png")} /></Row>
                            })}
                        </Col>
                    </Row>                              
            ...
            <Row className="justify-content-center mt-2">
                <Col xs="4">
                    <Col xs={{span:4,offset:4}} >
                        {<img className="img-fluid horizontal-deck-left" src= {require("../assets/MazoNaipes/" + checkRightDeck(player6) + ".png")}/>}                        
                    </Col>                        
                </Col>
                <Col xs="4">                                        
                    <Row>
